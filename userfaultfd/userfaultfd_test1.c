...
static void *handler(void *arg)
{
	...
	for (;;) {
		...
		if (msg.event & UFFD_EVENT_PAGEFAULT) // added by Alexios Voulimeneas
			printf("==> Event is pagefault on %p flags 0x%llx write? 0x%llx \n" // added by Alexios Voulimeneas
				, (void *)msg.arg.pagefault.address // added by Alexios Voulimeneas
				, msg.arg.pagefault.flags // added by Alexios Voulimeneas
				, msg.arg.pagefault.flags & UFFD_PAGEFAULT_FLAG_WRITE // added by Alexios Voulimeneas
		); // added by Alexios Voulimeneas
...
// gcc -pthread userfaultfd_test1.c
// ./a.out > log
